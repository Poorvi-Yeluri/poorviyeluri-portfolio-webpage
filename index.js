...
function populateAboutSection(basics) {
  document.getElementById("about-section").innerHTML = `
    ...
    <div class="content-text" style="line-height: 1.6em">
     ...
     <p>A highly motivated IT student at Monash University with practical experience in <strong style="color: white">Full-stack development</strong>, I thrive on solving challenging problems and building efficient, scalable solutions.</p> 
